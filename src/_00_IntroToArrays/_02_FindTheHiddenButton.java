...
public class _02_FindTheHiddenButton implements ActionListener {
	...
	public void start() {
		...
		// 3
		this.button = new JButton[number];
		...
		JOptionPane.showMessageDialog(null, "The smarter you are, the quicker you'll find the button...");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (buttonClicked == button[hiddenButton]) {
			JOptionPane.showMessageDialog(null, "Wow! Congrats!");
		}
